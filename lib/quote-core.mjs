 ...
 *
 * Security baseline R8: redisStore.save()/setStatus() reject every non-2xx
 * Upstash response; a persistence failure surfaces as 503 — never a false
 * 201 (intake) or 200 (admin). See SECURITY_BASELINE.md / SECURITY_HARDENING_GATE_B.md.
 */
