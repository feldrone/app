...
// footer
parts.push(
  `<text x="${M}" y="${H - 44}" font-family="Inter" font-size="13" fill="${FOOT}">${esc("regenerated by scripts/brand-board.mjs from scripts/brand-gen.mjs output \u00b7 identity v5.0 \u00b7 2026-09 \u00b7 geometry: v3 skeleton + v4 lab + v5 motion pass")}</text>`,
);
parts.push(
