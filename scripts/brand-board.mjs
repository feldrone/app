...
// masthead
parts.push(`<text x="${M}" y="96" font-family="Inter" font-size="40" font-weight="700" fill="${TITLE}">${esc("FELDRONE — identity system v7 \u201cTHE VANE\u201d")}</text>`);
parts.push(
  `<text x="${M}" y="134" font-family="Inter" font-size="17" fill="${SUB}">${esc("a proprietary F read as a windsock at wind: mast stem, tapered cone top arm (32u\u219212u), lighter airflow bar \u00b7 the word\u2019s F carries the same wedge \u00b7 monochrome first")}</text>`,
);
parts.push(
  `<text x="${M}" y="160" font-family="Inter" font-size="14" fill="${SUB}">${esc("v7.0 full redesign per client brief of 2026-09-13 \u2014 integer grid 136\u00d7160, flat filled geometry, custom one-word FELDRONE (cap 72 / stem 12, 45\u00b0 chamfers) \u00b7 one geometry source: scripts/brand-gen.mjs")}</text>`,
);
...
parts.push(brandImg("public/brand/fel-drone-horizontal.svg", M + (PW - 1240) / 2, p1y + (p1h - 306.2) / 2, 306.2, 1240));
...
parts.push(brandImg("public/brand/fel-drone-symbol.svg", M + 900, barY + (barH - 32) / 2, 32, 32 * (136 / 160)));
parts.push(brandImg("public/brand/fel-drone-symbol.svg", M + 952, barY + (barH - 24) / 2, 24, 24 * (136 / 160)));
parts.push(
...
// footer
parts.push(
  `<text x="${M}" y="${H - 44}" font-family="Inter" font-size="13" fill="${FOOT}">${esc("regenerated by scripts/brand-board.mjs from scripts/brand-gen.mjs output \u00b7 identity v7.0 \u00b7 2026-09 \u00b7 \u201cTHE VANE\u201d windsock-F per client brief of 2026-09-13 \u00b7 integer grid 136\u00d7160")}</text>`,
);
parts.push(
