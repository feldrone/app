 ...
 *
 * The mobile sheet is portalled to <body> (v4 fix): inside the header it
 * lived in a `backdrop-blur` ancestor, and a filtered element becomes the
 * containing block for its `position: fixed` descendants — the sheet sized
 * itself against the 76 px rail instead of the viewport and scrolled with
 * the page behind it. At body level, `fixed` is viewport-anchored again and
 * the z-40 sheet still sits under the z-50 rail that keeps its close button.
 */
